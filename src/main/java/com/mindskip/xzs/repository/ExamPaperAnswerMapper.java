...
public interface ExamPaperAnswerMapper extends BaseMapper<ExamPaperAnswer> {
    List<ExamPaper> hasDone(Integer paperId, Integer userId);
    ...
    List<ExamPaperAnswer> adminCorrectPage(com.mindskip.xzs.viewmodel.admin.paper.ExamPaperAnswerPageRequestVM requestVM);
}
