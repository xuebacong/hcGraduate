...
public class UserController extends BaseApiController {
    ...
    @RequestMapping(value = "/chat/{s}",produces = "application/json;charset=utf-8")
    public String chat(@RequestParam(required = false) String s)
    {
        System.out.println("chat方法被调用了");
        //国内需要代理
    ...
    {
        System.out.println("test1方法被调用了+"+s);
        //国内需要代理
        Proxy proxy = Proxys.http("127.0.0.1", 7890);
        //socks5 代理
        // Proxy proxy = Proxys.socks5("127.0.0.1", 1080);
